...
const UpdateItems = () => {
  ...
  return (
    ...
    <div className='w-full md:w-1/2 border p-10 rounded-md bg-[#F3F3F3]'>
        <div>
            <HeadingTitle heading="UPDATE ITEM"></HeadingTitle>
            <form className='pt-10' onSubmit={handleSubmit(onSubmit)}>
                ...
                <input type="submit" className='py-4 w-full bg-[#D1A054] text-white cursor-pointer font-semibold mt-5 rounded-lg hover:bg-black duration-500' value="Update Recipe Details" />
            </form>
         </div>
    </div>
</>
